...
I'd love to see sorts of things my friends and other fellow nerds bring with them, so please <EmailLink>show me what you pack with you!</EmailLink>

There are no affiliate links here, I'm not trying to sell you anything, I'm just a nerd.
...
- Anker PowerCore+ Mini (discontinued) with a USB-A plug to USB-C recepticle adapter
- Glasses cleaner spray: I use woosh but they're almost all the same
...
- Emergency meds
- Alcohol swabs
- Salt and pepper packets: Great for when the resturaunt forgot to salt your fries

In the large mesh organizer I have a 
- Microfiber cloth 
and a small mesh bag with
...
- Blue key fob
- Black key fob
If im staying at a Hotel or In another city, this is where i'll keep my hotel card and or transit card for quick access
...
- YubiKey 5 NFC
- Tiny zip lock bag
- A 2nd tiny zip lock bag with sewing pins.

The sewing pins are super useful if ever i have to clean out a pair of earbuds,
swap a sim card or clean out a charging port. They're so little weight and so
much use

The empty tiny zip lock bag is great too for spare sim cards or for my earrings
...
- 3 ft ethernet cable
- Plugable USBC-E1000 (USB-C to gigabit ethernet adapter): I've found ive just been leaving this at work since it's where it gets the most use
...
The 2nd strap broke, so I got a coworker to make some new leather pieces to sew in. I'll add photos here when he's done
...
- Emergency snacks (granola bars or peanuts)
- N95 masks
- Spare earbuds
