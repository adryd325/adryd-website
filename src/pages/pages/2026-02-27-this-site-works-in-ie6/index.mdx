...
title: This website works on Internet Explorer 6
date: 2026-02-28
description: "in which I discover it has JavaScript in CSS and I make a custom font"
---
...
The first big thing to tackle was both CSS variables and REM units not being 
...
[^4]: I wonder what kinds of crazy things like https://lyra.horse/x86css/ would be possible if this was still a widespread feature. It'd probably ruin the fun of the challenge though
