...
<Picture src={import("./_image-4.png")} alt={"A photo of a key, with the blade ground off, held down onto a flatbed scanner with an adjustable wrench"} />
<figure>A photo of a key, with the blade ground off, held down onto a flatbed scanner with an adjustable wrench</figure>

<Picture src={import("./_image-6.png")} alt={"A screenshot of inkscape. There is red shape in the shape of the warding traced uppon a scan of the key"}/>
<figure>A screenshot of inkscape. There is red shape in the shape of the warding traced uppon a scan of the key</figure>
